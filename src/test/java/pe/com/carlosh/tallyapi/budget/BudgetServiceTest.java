...
class BudgetServiceTest {
    ...
    class FindAll {
        ...
        void success() {
            ...
            when(expenseRepository.sumByFilters(USER_ID, null, BUDGET_ID, null, null)).thenReturn(new BigDecimal("250.00"));
        ...
        void noBudgets() {
            ...
            verify(expenseRepository, never()).sumByFilters(any(), any(), any(), any(), any());
        }
        ...
        void overspent() {
            ...
            when(budgetRepository.findByUserIdAndActiveTrue(USER_ID, pageable)).thenReturn(page);
            when(expenseRepository.sumByFilters(USER_ID, null, BUDGET_ID, null, null)).thenReturn(new BigDecimal("1200.00"));
        ...
        void multipleBudgets() {
            ...
            when(budgetRepository.findByUserIdAndActiveTrue(USER_ID, pageable)).thenReturn(page);
            when(expenseRepository.sumByFilters(USER_ID, null, BUDGET_ID, null, null)).thenReturn(new BigDecimal("250.00"));
            when(expenseRepository.sumByFilters(USER_ID, null, 101L, null, null)).thenReturn(new BigDecimal("400.00"));
    ...
    class Update {
        ...
        void success() {
            ...
            when(categoryRepository.findByIdAndUserIdAndActiveTrue(CATEGORY_ID, USER_ID)).thenReturn(Optional.of(category));
            when(expenseRepository.sumByFilters(USER_ID, null, BUDGET_ID, null, null)).thenReturn(new BigDecimal("100.00"));
        ...
        void sameNameSkipsDuplicateCheck() {
            ...
            when(budgetRepository.findByIdAndUserIdAndActiveTrue(BUDGET_ID, USER_ID)).thenReturn(Optional.of(budget));
            when(expenseRepository.sumByFilters(USER_ID, null, BUDGET_ID, null, null)).thenReturn(BigDecimal.ZERO);
